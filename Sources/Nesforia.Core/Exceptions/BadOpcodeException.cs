...
namespace Nesforia.Core.Exceptions
{
    ...
    {
        public BadOpcodeException(Opcode opcode)
        {
            Opcode = opcode;
        }

        public BadOpcodeException(Opcode opcode, String message) : base(message)
        {
            Opcode = opcode;
        }

        public BadOpcodeException(Opcode opcode, String message, Exception innerException) : base(message, innerException)
        {
            Opcode = opcode;
        }
